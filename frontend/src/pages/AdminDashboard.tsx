  ...
  const fetchData = async () => {
    try {
      ...
      const [commRes, statsRes] = await Promise.all([
        axios.get(`${API_BASE_URL}/communities/admin/my-communities`, {
          headers: { Authorization: `Bearer ${token}` },
        }),
        axios.get(`${API_BASE_URL}/users/admin/stats`, {
          headers: { Authorization: `Bearer ${token}` },
        }),
      ]);
        ...
        return stats ? (
          <div>
            ...
            <div className="grid grid-stats" style={{ marginTop: '1.5rem' }}>
              <div className="stat-card bg-gradient-to-r from-blue-500 to-blue-700">
                <h2>{stats.totalUsers}</h2>
                <p>Total Students</p>
              </div>
              <div className="stat-card bg-gradient-to-r from-green-500 to-green-700">
                <h2>{stats.myEvents}</h2>
                <p>My Events</p>
              </div>
              <div className="stat-card bg-gradient-to-r from-yellow-500 to-yellow-700">
                <h2>{stats.myMembers}</h2>
                <p>Community Members</p>
              </div>
              <div className="stat-card bg-gradient-to-r from-red-500 to-red-700">
              ...
              <form onSubmit={handleCreateCommunity}>
                ...
                <div style={{ marginBottom: '1rem' }}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewCommunity({ ...newCommunity, collegeName: e.target.value })
                    }
                    required
                    className="input-field"
